...
impl<'a> MessageList<'a> {
	...
	pub fn new(
		...
		Self { messages, theme, scroll_offset: 0, shimmer: None, typing_indicator: None, message_areas }
	}
	...
	pub fn with_scroll(
		...
		Self { messages, theme, scroll_offset, shimmer: None, typing_indicator: None, message_areas }
	}
