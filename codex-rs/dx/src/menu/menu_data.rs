...
pub struct Menu {
	...
	pub menu_area: Rect,
	pub window_control_area: Rect, // Area for red dot (close button)
	...
	pub content_viewer_mode: bool, // Track if showing content viewer
	pub content_viewer_title: String, // Title for content viewer
	pub content_viewer_text: String, // Text content to display
}
...
impl Menu {
	pub fn new(theme: ChatTheme) -> Self {
		...
		Self {
			...
			window_control_area: Rect::default(),
			...
			content_viewer_mode: false,
			content_viewer_title: String::new(),
			content_viewer_text: String::new(),
		}
	}
	...
	/// Show content viewer with title and text
	pub fn show_content_viewer(&mut self, title: String, content: String) {
		self.content_viewer_mode = true;
		self.content_viewer_title = title;
		self.content_viewer_text = content;
	}

	/// Close content viewer and return to normal menu
	pub fn close_content_viewer(&mut self) {
		self.content_viewer_mode = false;
		self.content_viewer_title.clear();
		self.content_viewer_text.clear();
	}
}
