...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'doctor.empty_hint': '点击"运行诊断"检查您的 Agent 安装。',
  ...
  en: {
    ...
    'doctor.empty_hint': 'Click "Run Diagnostics" to check your Agent installation.',
  ...
  tr: {
    ...
    'doctor.empty_hint': 'Agent kurulumunuzu kontrol etmek için "Tanı Çalıştır" düğmesine tıklayın.',
