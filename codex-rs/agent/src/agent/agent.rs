...
impl Agent {
    ...
    pub async fn run_interactive(&mut self) -> Result<()> {
        println!("◆ DX-Agent Interactive Mode");
...
mod tests {
    ...
    async fn from_config_passes_extra_headers_to_custom_provider() {
        ...
        config
            .extra_headers
            .insert("User-Agent".to_string(), "agent-web-test/1.0".to_string());
        config
            .extra_headers
            .insert("X-Title".to_string(), "agent-web".to_string());
