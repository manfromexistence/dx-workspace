...
/// Maps a single Nevis role to Agent permissions.
...
/// IAM policy engine that maps Nevis roles to Agent tool permissions.
///
...
mod tests {
    ...
    fn test_mappings() -> Vec<RoleMapping> {
        vec![
            RoleMapping {
                ...
                agent_permissions: vec!["all".into()],
            ...
            RoleMapping {
                ...
                agent_permissions: vec!["file_read".into(), "memory_search".into()],
    ...
    fn duplicate_normalized_roles_are_rejected() {
        let mappings = vec![
            ...
            RoleMapping {
                nevis_role: " ADMIN ".into(),
                agent_permissions: vec!["file_read".into()],
