...
const SNAPSHOT_HEADER: &str = "# 🧠 Agent Memory Snapshot\n\n\
    > Auto-generated by Agent. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 Agent Memory Snapshot
...
I am Agent, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 Agent Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
