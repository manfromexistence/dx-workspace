...
use agent::providers::compatible::AuthStyle;
use agent::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use agent::providers::compatible::OpenAiCompatibleProvider;
