...
use agent::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
use agent::providers::{create_provider, create_provider_with_options, create_provider_with_url};
...
fn factory_resolves_openai_codex_provider() {
    let options = agent::providers::ProviderRuntimeOptions::default();
