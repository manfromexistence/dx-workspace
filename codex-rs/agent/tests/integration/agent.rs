...
//!
//! Ref: https://github.com/agent-labs/agent/issues/618 (item 6)
...
use dx_agent::providers::traits::ChatMessage;
use dx_agent::providers::{ChatResponse, ConversationMessage, ToolCall};
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: agent"));
