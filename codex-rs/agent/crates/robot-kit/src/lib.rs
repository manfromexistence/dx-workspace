//! # Agent Robot Kit
//!
//! A standalone robotics toolkit that integrates with Agent for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  Agent AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use agent_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of Agent. It defines its own
//! `Tool` trait that is compatible with Agent's but doesn't require it.
//!
//! ## Safety
//!
